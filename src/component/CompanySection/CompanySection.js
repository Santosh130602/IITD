        ...
        <>
            <div className="CompanySection">
                ...
                <div className="company-section">
                    <div className="company-logos">
                        <div className="logo-container">
                        <img className="comp-logo" src = {Apple}></img>
                        </div>
                        <div className="logo-container">
                        <img className="comp-logo" src = {Google}></img>
                        </div>
                        <div className="logo-container">
                        <img className="comp-logo" src = {Microsoft}></img>
                        </div>
                        <div className="logo-container">
                        <img className="comp-logo" src = {Amazone}></img>
                        </div>
                        <div className="logo-container">
                        <img className="comp-logo" src = {Flipkart}></img>
                        </div>
